...
namespace SqlServerTutorial.Basic {
    class Distinct {
        ...
        public void A() {
            ...
            #region A
            var query = DbContext.Set<Cities>().Query((Customers customer, Cities city) => {
        ...
        public void B() {
            ...
            #region B
            var query = DbContext.Set<CityState>().Query((Customers customer, CityState city) => {
        ...
        public void C() {
            ...
            #region C
            var query = DbContext.Set<Phones>().Query((Customers customer, Phones phones) => {
        ...
        public void C1() {
            ...
            #region C1
            var query = DbContext.Set<CityStateZip>().Query((Customers customer, CityStateZip cityStateZip) => {
                ...
                ORDER(BY(customer.City), BY(customer.State), BY(customer.ZipCode));
